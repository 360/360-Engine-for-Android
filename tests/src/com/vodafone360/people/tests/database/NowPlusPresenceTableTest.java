...
// 		now, update the user
		...
		User user1 = PresenceTable.getUserPresenceByLocaContactId(12L, mTestDatabase.getReadableDatabase());
	...
	public void testGetMeProfilePresenceById() {
		...
		assertNull(PresenceTable.getUserPresenceByLocaContactId(-1L, mTestDatabase.getReadableDatabase()));
