 ...
 */
public class FetchNativeContactsDummy extends BaseSyncProcessor {
     ...
     */
    protected FetchNativeContactsDummy(IContactSyncCallback callback, DatabaseHelper db,
            Context context, ContentResolver cr) {
        super(callback, db);
        
        final boolean firstTimeSync = false;
        NativeContactsApi.createInstance(context);
