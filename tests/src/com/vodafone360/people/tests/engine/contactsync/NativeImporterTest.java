...
public class NativeImporterTest extends TestCase {
     ...
     */
    private final static Account GMAIL_ACCOUNT_1 = new Account("mylogin@gmail.com", GMAIL_ACCOUNT_TYPE);
    
    /**
     * A test Gmail account.
     */
    private final static Account GMAIL_ACCOUNT_2 = new Account("mylogin2@googlemail.com", GMAIL_ACCOUNT_TYPE);
     ...
     */
    private final static Account THIRD_PARTY_ACCOUNT = new Account("mythirdpartylogin", THIRD_PARTY_ACCOUNT_TYPE);
    ...
    public void testMultipleImportsFromNativeWithUpdatedContact_updatedDetails() {
        ...
        for (int i = 0; i < originalContact.length; i++) {
            ...
            originalContact[i] = alterContactChangeValue(originalChange, originalChange.getValue());
        }
        nativeMockup.setContact(10, originalContact);
     ...
     */
    private boolean compareNativeAndPeopleContactsList(NativeContactsApiMockup ncam, Account[] accounts, PeopleContactsApiMockup pcam) {
     ...
     */
    private static class PeopleContactsApiMockup extends PeopleContactsApi {
     ...
     */
    private static class NativeContactsApiMockup extends NativeContactsApi {
     ...
     */
    private ContactChange alterContactChangeValue(ContactChange change, String newValue) {
     ...
     */
    private static ContactChange copyContactChange(ContactChange change) {
