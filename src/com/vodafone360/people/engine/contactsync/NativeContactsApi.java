...
/**
 * Class that provides an abstraction layer for accessing the Native Contacts
 * API. The underlying API to be used should be the most suitable for the SDK
 * version of the device.
 */
public abstract class NativeContactsApi {
    /**
     * Account type for 360 People in the Native Accounts. MUST be a copy of
     * type in 'res/xml/authenticator.xml'
     */
    protected static final String PEOPLE_ACCOUNT_TYPE = "com.vodafone360.people.android.account";

    /**
     * {@link NativeContactsApi} the singleton instance providing access to the
     * correct Contacts API interface
     */
