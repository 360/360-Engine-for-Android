...
public class LoginEngine extends BaseEngine {
    ...
    private void handleSignUpResponse(List<BaseDataType> data) {
        ServiceStatus errorStatus = genericHandleResponseType("Contact", data);
    ...
    private void handleNewPublicKeyResponse(List<BaseDataType> mDataTypes) {
        ...
        ServiceStatus errorStatus = genericHandleResponseType("PublicKeyDetails", mDataTypes);
        if (errorStatus == ServiceStatus.SUCCESS) {
    ...
    private void handleCreateSessionManualResponse(List<BaseDataType> data) {
        ...
        ServiceStatus errorStatus = genericHandleResponseType(AUTH_SESSION_HOLDER, data);
    ...
    private void handleRequestingActivationResponse(List<BaseDataType> data) {
        ...
        ServiceStatus errorStatus = genericHandleResponseType(STATUS_MSG, data);
        if (errorStatus == ServiceStatus.SUCCESS) {
            // Now waiting for SMS...
            setTimeout(ACTIVATE_LOGIN_TIMEOUT);
            return;
    ...
    private void handleServerSimpleTextResponse(List<BaseDataType> data) {
        ...
        ServiceStatus errorStatus = genericHandleResponseType("SimpleText", data);
        if (errorStatus == ServiceStatus.SUCCESS) {
