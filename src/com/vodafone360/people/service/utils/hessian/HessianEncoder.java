...
public class HessianEncoder {
    ...
    private static class MicroHessianOutputWorkaround extends MicroHessianOutput {
        private MicroHessianOutputWorkaround(OutputStream os) {
            super(os);
        }
    ...
    public static byte[] createHessianByteArray(String function, Hashtable<String, Object> ht)
        ...
        MicroHessianOutput mho = new MicroHessianOutputWorkaround(bos);
