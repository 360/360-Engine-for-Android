...
public class HessianDecoder {
        ...
        if (mhi != null) {
            ...
            try {
                ...
                if (Settings.ENABLED_TRANSPORT_TRACE) {
                    // is = CopyInputStream.expensiveLog("Log zipped data", is);
                }
    ...
    private List<BaseDataType> decodeResponse(InputStream is, Request.Type type) throws IOException {
        ...
        if (tag != 'M') {
            ...
            if (map.containsKey(KEY_SESSION)) {
                ...
                // Object obj = (Vector<Hashtable<String, Object>>)map
    ...
    private void decodeResponseByRequestType(List<BaseDataType> clist,
        ...
        // LogUtils.logD("HessianDecoder.decodeResponseByRequestType() type["+type+"] type.name["+type.name()+"]");
        switch (type) {
            ...
            case FRIENDSHIP_REQUEST:
                // clist.add(FriendshipRequests.createFromHashtable(hash));
                break;
        ...
        if (type != null) {
            switch (type) {
                ...
                case SYSTEM_NOTIFICATION:
                    LogUtils.logV("SYSTEM_NOTIFICATION push msg:");
