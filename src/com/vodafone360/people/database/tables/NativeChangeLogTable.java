        ...
        try {
            ...
            if (cursor.getCount() > 0) {
                ...
                while (cursor.moveToNext()) {
                    ...
                    // LocalContactId=1
                    change.setInternalContactId(cursor.isNull(1) ? -1L : cursor.getLong(1));
                    // NativeContactId=2
                    change.setNabContactId(cursor.isNull(2) ? -1L : cursor.getLong(2));
                    // DetailLocalId=3
                    change.setInternalDetailId(cursor.isNull(3) ? -1 : cursor.getInt(3));
                    // NativeDetailId=4
                    change.setNabDetailId(cursor.isNull(4) ? -1L : cursor.getLong(4));
                    // DetailKey=5
