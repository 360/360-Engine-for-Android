...
public abstract class ContactSummaryTable {
     ...
     * DatabaseHelper.trace(true, "ContactSummeryTable.mergeContact()"); } try {
     * return writableDb.compileStatement("UPDATE " + TABLE_NAME + " SET " +
     * Field.NATIVEID + "=? WHERE " + Field.LOCALCONTACTID + "=?"); } catch
     * (SQLException e) {
     * LogUtils.logE("ContactSummeryTable.mergeContactStatement() compile error:\n"
     * , e); return null; } }
     */
    ...
    public static ServiceStatus updateNameAndStatus(Contact contact, SQLiteDatabase writableDb) {
        ...
        try {
            ...
            statement1.bindString(1, nameString);
            statement1.bindString(2, statusString);
            statement1.bindLong(3, altDetailType);
            statement1.bindLong(4, altFieldType);
            statement1.bindString(5, sns);
            statement1.bindLong(6, contact.localContactID);
