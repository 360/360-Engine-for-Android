...
public class EncryptionUtils {
     ...
     * @return byte array containing encrypted password, return NULL if supplied password Strind
     *         is NULL, or an exception is thrown.
     ...
     * @return string
     */
    public static String decryptPassword(byte[] passwordEn) {
        if (!createCipher()) {
            return null;
        }
        try {
    ...
    private static boolean createCipher() {
        ...
        try {
            ...
            LogUtils
                    .logE(
                            "EncryptionUtils.encryptPassword() Create Cipher failed - NoSuchPaddingException",
                            e);
            return false;
        }
        return true;
