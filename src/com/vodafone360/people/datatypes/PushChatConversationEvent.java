...
public class PushChatConversationEvent extends PushEvent {
    ...
    public PushChatConversationEvent(RpgPushMessage msg, EngineId engine) {
        super();
        mEngineId = engine;
        mConversation = new Conversation(msg);
