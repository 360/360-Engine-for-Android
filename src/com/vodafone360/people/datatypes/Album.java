...
/**
 * Album is data type sent to server telling the.
 * name of album as title.
 * @author mayank
 *
 */
public class Album extends BaseDataType implements Parcelable {
    /**
    ...
    /**
     * albumid sent to server value null.
     */
    ...
    /**
     * contentid last added.
     */
    public Long lastaddedcontentid = null;
    ...
    /**
     * finding the tag.
     * @param tag for the input as string.
     * @return founded tags.
     */
    ...
    private void setValue(final Tags tag, final Object value) {
        ...
        case TITLE:
            title = (String) value;
            break;
        case LASTADDEDCONTENTID:
            lastaddedcontentid = (Long) value;
            break;
        default:
